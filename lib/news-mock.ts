...
export const NEWS_MOCK: NewsItem[] = [
  // ── 2026-06-12 큐레이션 (원본 기사 직접 읽고 중립 요약) ──
  {
    id: "20260612-morning-rebound",
    date: "2026-06-12",
    publishedAt: "2026-06-12T08:40:00+09:00",
    headline: "중동 완화·美 반도체 급등에 코스피 갭업 전망…8천선 재도전",
    summary:
      "6월 12일 코스피는 갭 상승 출발이 예상됩니다. 간밤 미국 증시가 반도체 주도로 급등(나스닥 +2.54%·필라델피아 반도체지수 +7.91%로 1년 만에 최대폭)했고 인텔·마이크론 등이 9~11% 뛰었습니다. 트럼프 대통령이 '이란과 전쟁 합의'를 발표하며 중동 리스크와 유가 부담이 완화된 영향입니다. 다만 외국인이 24거래일 연속 순매도 중이고 美 PPI가 예상보다 높아 연준의 매파 기조 우려가 남아, 갭업이 실수요로 이어지는지가 관건으로 봅니다.",
    source: "newspim.com",
    sourceUrl: "https://www.newspim.com/news/view/20260612000143",
    keywords: ["코스피", "반도체", "삼성전자", "하이닉스"],
    stocks: ["삼성전자", "SK하이닉스"],
    personaComments: {},
  },
  {
    id: "20260612-spacex-ipo",
    date: "2026-06-12",
    publishedAt: "2026-06-12T07:20:00+09:00",
    headline: "스페이스X, 나스닥 'SPCX' 상장…113조 조달 역대 최대 IPO",
    summary:
      "스페이스X가 6월 12일(현지시각) 나스닥에 티커 'SPCX'로 상장합니다. 공모가는 주당 135달러로, 5억5555만여 주를 매각해 약 750억 달러(113조원)를 조달하는 역대 최대 규모 IPO입니다. 상장 후 15거래일 내 나스닥100 지수에 자동 편입돼 QQQ 등 추종 ETF 보유자는 간접 노출을 갖게 됩니다. 국내 우주항공 테마 투자심리에도 영향을 줄 수 있는 이벤트로 봅니다.",
    source: "g-enews.com",
    sourceUrl: "https://www.g-enews.com/view.php?ud=2026061207200514202bd56fbc3c_1",
    keywords: ["스페이스X", "우주항공", "IPO", "나스닥"],
    stocks: [],
    personaComments: {},
  },
